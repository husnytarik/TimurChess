...
The platform works on both mobile and desktop browsers with no installation required. Users can create profiles, add friends, track scores, and view match history.
...
- Match history & live match status
...
- 🌐 Public rooms  
- 🔒 Private rooms  
- Real-time room & data management using Firebase Realtime Database  
...
### 💬 Communication
- 🎙️ Low-latency browser-based voice chat  
- 💬 Text chat system
...
- Firebase Realtime Database (rooms, match state, chat)  
...
## ♜ About Timur Chess
Timur Chess (Tamerlane Chess) is a 14th-century chess variant played during the reign of Timur.

- Larger board than classical chess  
- Additional unique pieces and moves  
- Deeper strategic complexity  

This project modernizes the historical game with online multiplayer and real-time systems.
